...
- Status: Intermediate step - performance degraded as expected after removing main signal
- Next: V3 will add regime detection features to restore/improve performance
...
V2 Feature Set (10 core):
- Leading: industrial_production_index, stock_market_index, 
  interest_rate_short_term, capital_formation
- Coincident: employment_level, unemployment_rate, cpi_annual_growth,
...
Reference: See NOWCASTING_V2_RESULTS.md for detailed analysis
"""
...
NOWCAST_FEATURES = LEADING_INDICATORS + COINCIDENT_INDICATORS
