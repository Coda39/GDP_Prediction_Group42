...
print("Downloading S&P 500 from Yahoo Finance (1980-2024)...")
...
# Load existing data
print("\nLoading existing FRED data...")
df = pd.read_csv('../../Data/historical/usa_extended_with_financial_1980-2024.csv', 
...
# Save updated file
df.to_csv('../../Data/historical/usa_extended_with_financial_1980-2024.csv')

print("\n✓ Fixed! S&P 500 now complete from Yahoo Finance")
print(f"✓ Saved to: ../../Data/historical/usa_extended_with_financial_1980-2024.csv")
