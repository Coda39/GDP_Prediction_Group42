"""
GDP Nowcasting Pipeline - V4 (Critique of V3)
==============================================
This script investigates V3's unexpectedly high performance by removing 
features suspected of data leakage.

VERSION 4 (October 29, 2025):
- Takes V3's feature set
- REMOVES features that contain current quarter GDP:
  * gdp_momentum (uses current GDP in calculation)
  * gdp_volatility_4q (rolling window includes current quarter)

- Purpose: Test if V3's success was due to data leakage

V4 Feature Set (13 total - Clean Subset of V3):
...
- Clean Regime (3): stock_volatility_4q, inflation_momentum, high_inflation_regime

Expected Result: If V3's high R² was from data leakage, removing these 
features should cause performance to collapse.

Reference: See NOWCASTING_V4_RESULTS.md for analysis
"""
import pandas as pd
import numpy as np
...
REGIME_FEATURES = [
    ...
    # 'gdp_momentum',           #  Uses current GDP
    # 'gdp_volatility_4q',      #  Rolling window includes current GDP
    'high_volatility_regime', #  Uses gdp_volatility_4q
