...
Input:
- ../../Data/raw/france_data_no_money_supply.csv
- ../../Data/bloomberg/Europe Corporate.xlsx
- ../../Data/bloomberg/France Gov 2Y.xlsx
- ../../Data/bloomberg/France Gov 5Y.xlsx
- ../../Data/bloomberg/France Gov 10Y.xlsx

Output:
- ../../Data/extended/france_extended_with_bloomberg.csv (1991-2025)
"""
...
# File paths
DATA_DIR = Path('../../Data')
INPUT_CURRENT = DATA_DIR / 'raw' / 'france_data_no_money_supply.csv'
BLOOMBERG_DIR = DATA_DIR / 'bloomberg'
OUTPUT_PATH = DATA_DIR / 'extended' / 'france_extended_with_bloomberg.csv'
