...
Input:
- ../../Data/raw/japan_data.csv (OECD base data 2000-2025)
...
Output:
- ../../Data/extended/japan_extended_with_bloomberg.csv (Full 1980-2025)
...
# File paths
DATA_DIR = Path('../../Data')
INPUT_CURRENT = DATA_DIR / 'raw' / 'japan_data.csv'
INPUT_HISTORICAL = DATA_DIR / 'historical' / 'japan_historical_1980-2000.csv'
BLOOMBERG_DIR = DATA_DIR / 'bloomberg'
OUTPUT_PATH = DATA_DIR / 'extended' / 'japan_extended_with_bloomberg.csv'
