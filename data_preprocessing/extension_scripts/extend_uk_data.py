"""
UK DATA EXTENSION - Add Bloomberg Financial Features
====================================================
...
# FRED series for UK (if available)
FRED_SERIES = {
    'consumer_confidence': 'CSCICP03GBM665S',  # UK Consumer Confidence
    'retail_sales': 'SLRTTO01GBM657S',  # UK Retail Sales
}
...
# Bloomberg files
BLOOMBERG_FILES = {
    'corporate': BLOOMBERG_DIR / 'UK Corporate.xlsx',
    'gov_2y': BLOOMBERG_DIR / 'UK Gov 2Y.xlsx',
    'gov_5y': BLOOMBERG_DIR / 'UK Gov 5Y.xlsx',
    'gov_10y': BLOOMBERG_DIR / 'UK Gov 10Y.xlsx',
}
...
def load_and_merge_base_data():
    """Load and merge historical + current UK data"""
    print("="*80)
...
def main():
    print("="*80)
    print(" UK DATA EXTENSION - BLOOMBERG FINANCIAL INDICATORS")
    print("="*80)
    ...
    print("  ✓ UK Sterling Corporate Bond Index (LC61TRGU)")
    print("  ✓ UK Government Bonds (2Y, 5Y, 10Y)")
    print("="*80 + "\n")
    ...
    print("     G7_COUNTRIES['UK']['file'] = 'uk_extended_with_bloomberg.csv'")
    print("     G7_COUNTRIES['UK']['active'] = True")
    print("     COUNTRIES_TO_PROCESS = ['UK']")
    ...
    print("  1980-1989: Historical data only")
    print("  1989-1998: Historical + Gov bonds")
    print("  1998-2025: Full coverage (all indicators)")
    print("="*80)
