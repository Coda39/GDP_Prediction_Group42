...
Output: germany_extended_with_bloomberg.csv (1980-2025)
"""
...
# File paths
DATA_DIR = Path('../../../Data')
INPUT_CURRENT = DATA_DIR / 'germany_data_no_money_supply.csv'
BLOOMBERG_DIR = DATA_DIR / 'bloomberg'
OUTPUT_PATH = DATA_DIR / 'germany_extended_with_bloomberg.csv'
